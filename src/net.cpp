...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Deluxcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"deluxcointools.com", "27.117.7.80"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"deluxcointools.com", "testnet-seed.deluxcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Deluxcoin is probably already running."), addrBind.ToString().c_str());
        else
